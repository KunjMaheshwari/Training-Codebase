...
public class MainClass {
	...
	int rowNum = 0; // Initializing the row count.

	@BeforeClass
	public void setUp() throws FileNotFoundException {
		//Creating a new File
		file= new FileOutputStream(System.getProperty("user.dir")+"\\testdata\\MiniProjectExcelFile.xlsx");
		//Creating a workbook
		...
		//Using Wait() to wait for 20 seconds.
	...
	@DataProvider(name = "dp", indices = {1}) // passing the test data to the methods.
	Object[][] inputSearch(){
		Object data[][] = {
	...
	public void searchMobilePhone(String searchText) {
		//Searching for the "Mobile Smart phones under 30000" on the search box
	...
	@Test(priority=1, dependsOnMethods= {"searchMobilePhone"})
	public void sortByNewestArrival() {
		//Selecting the "Sort By" DropDown Menu and clicking on it.
		...
		try {
			Assert.assertEquals(isSelectedNewestArrivals, "Newest Arrivals");
			verificationResult = "Newest Arrivals Verified";
		}catch(AssertionError e) {
			verificationResult = "Verification Failed" + e.getMessage();
		}
